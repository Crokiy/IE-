<template>
    <div>
        <div>
            <p>基础用法 <br>在选项中设置disabled: true,即可禁用<br>添加change-on-select属性赋值为true，即可选择即改变</p>
            <div class="block">
                <span class="demonstration">默认 click 触发子菜单</span>
                <el-cascader change-on-select :options="options" v-model="selectedOptions">
                </el-cascader>
            </div>
            <div class="block">
        ...
        <div>
            ...
            <div class="block">
                <span class="demonstration">只可搜索最后一级菜单的选项</span>
                <el-cascader placeholder="试试搜索：指南" :options="options" filterable></el-cascader>
            </div>
            <div class="block">
                <span class="demonstration">可搜索任意一级菜单的选项</span>
        ...
        <div>
            ...
            <p style="padding-top:100px">扩展</p>
